...
public class OTPServiceTest {
    ...
    @Test
    public void shouldNotBeAbleToLoginAgainWithPreviousOTPAfterSuccessfulAttempt() throws Exception {
        OTP otp1 = otpService.generateAndSaveOtpFor("user");
        otpService.validateOTPFor("user", otp1.toString());

        OTP otp2 = otpService.generateAndSaveOtpFor("user");
        otpService.validateOTPFor("user", otp1.toString());

        verifyLogMessages("OTP " + otp1.toString() + " generated for user",
                "OTP " + otp1.toString() + " validation successful for user",
                "OTP " + otp2.toString() + " generated for user",
                "Failed attempt #1 using OTP " + otp1.toString() + " by user");

    }

    @Test
    public void shouldNotBeAbleToLoginWithPreviousOTPsIfMaxAttemptsReached() throws Exception {
        OTP otp1 = otpService.generateAndSaveOtpFor("user");
        ...
        verifyLogMessages("OTP " + otp1.toString() + " generated for user",
                ...
                "Failed attempt #3 using OTP " + wrongOTP1 + " by user",
                "Max failed OTP attempts exceeded for user",
                "OTP " + otp1.toString() + " sent by user is not generated by the system");
    }

    @Test
    public void shouldNotBeAbleToLoginWithPreviousOTPAfterSuccessfulLoginWithRegeneratedOTP() throws Exception {
        OTP otp1 = otpService.generateAndSaveOtpFor("user");
        OTP otp2 = otpService.regenerateAndSaveOtpFor("user");
        ...
        verifyLogMessages("OTP " + otp1.toString() + " generated for user",
                ...
                "OTP " + otp2.toString() + " validation successful for user",
                "OTP " + otp1.toString() + " sent by user is not generated by the system",
                "OTP " + otp2.toString() + " sent by user is not generated by the system");
    }
}